...
from predictions.utils import common

# torch
import torch


def load_data(_path, coords, joints, cycles=3):

    file_feature = os.path.join(_path)
    ...
    for si in range(num_samples):
        ...
        data_list.append(list(ff[ff_group_key]))#获取数据
